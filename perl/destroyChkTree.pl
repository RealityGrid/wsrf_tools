...
if( @ARGV < 1 )
{
  print "  Script to destroy a Checkpoint Tree\n\n";	
  print "Usage:\n destroyChkTree.pl URL [URL2 URL3...]\n\n";
  print "     URL is the endpoint of the service\n\n";
  print "destroyChkTree.pl http://localhost:50000/Session/RealityGridTree/RealityGridTree/19501981104038050279\n";
  exit;
}
...
while(defined($target = shift @ARGV)){
    ...
    my $ans=  WSRF::Lite
	-> uri("http://www.sve.man.ac.uk/CheckPointTree")
